...
| {debian} 9  | SUSE Linux Enterprise Client Tools Debian 9 amd64
| {debian} 10 | SUSE Linux Enterprise Client Tools Debian 10 amd64
|===
...
[[debian-channels-cli]]
[cols="1,1,1,1,1", options="header",separator=|]
.Debian Channels - CLI
|===
