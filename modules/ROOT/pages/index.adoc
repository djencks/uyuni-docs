...
| xref:administration:admin-overview.adoc[Administration Guide] | icon:file-pdf[link="./pdf/suse_manager__administration_guide-pdf.pdf", window="_blank" role="green"]
...
| icon:file-pdf[link="{attachmentsdir}/pdfs/uyuni_installation_guide.pdf", window="_blank" role="green"]

| xref:client-configuration:client-config-overview.adoc[Client Configuration Guide]
| icon:file-pdf[link="{attachmentsdir}/pdfs/uyuni_client-configuration_guide.pdf", window="_blank" role="green"]


| xref:upgrade:upgrade-overview.adoc[Upgrade Guide]
| icon:file-pdf[link="{attachmentsdir}/pdfs/uyuni_upgrade_guide.pdf", window="_blank" role="green"]

| xref:reference:reference-overview.adoc[Reference Guide]
| icon:file-pdf[link="{attachmentsdir}/pdfs/uyuni_reference_guide.pdf", window="_blank" role="green"]


| xref:administration:admin-overview.adoc[Administration Guide]
| icon:file-pdf[link="{attachmentsdir}/pdfs/uyuni_administration_guide.pdf", window="_blank" role="green"]

| xref:salt:salt-overview.adoc[Salt Guide]
| icon:file-pdf[link="{attachmentsdir}/pdfs/uyuni_salt_guide.pdf", window="_blank" role="green"]


| xref:retail:retail-overview.adoc[Retail Guide]
| icon:file-pdf[link="{attachmentsdir}/pdfs/uyuni_retail_guide.pdf", window="_blank" role="green"]

| xref:quickstart-public-cloud:qs-publiccloud-overview.adoc[Quick Start Guide - Public Cloud]
| icon:file-pdf[link="{attachmentsdir}/pdfs/uyuni_quickstart-public-cloud_guide.pdf", window="_blank" role="green"]


| xref:large-deployments:large-deployments-overview.adoc[Large Deployments Guide]
| icon:file-pdf[link="{attachmentsdir}/pdfs/uyuni_large-deployments_guide.pdf", window="_blank" role="green"]
...
| xref:installation:install-overview.adoc[Installation Guide]
| link:{attachmentsdir}/pdfs/uyuni_installation_guide.pdf[I, window="_blank" role="green"]

| xref:client-configuration:client-config-overview.adoc[Client Configuration Guide]
| link:{attachmentsdir}/pdfs/uyuni_client-configuration_guide.pdf[CC, window="_blank" role="green"]


| xref:upgrade:upgrade-overview.adoc[Upgrade Guide]
| link:{attachmentsdir}/pdfs/uyuni_upgrade_guide.pdf[U, window="_blank" role="green"]

| xref:reference:reference-overview.adoc[Reference Guide]
| link:{attachmentsdir}/pdfs/uyuni_reference_guide.pdf[Ref, window="_blank" role="green"]


| xref:administration:admin-overview.adoc[Administration Guide]
| link:{attachmentsdir}/pdfs/uyuni_administration_guide.pdf[A, window="_blank" role="green"]

| xref:salt:salt-overview.adoc[Salt Guide]
| link:{attachmentsdir}/pdfs/uyuni_salt_guide.pdf[S, window="_blank" role="green"]


| xref:retail:retail-overview.adoc[Retail Guide]
| link:{attachmentsdir}/pdfs/uyuni_retail_guide.pdf[R, window="_blank" role="green"]

| xref:quickstart-public-cloud:qs-publiccloud-overview.adoc[Quick Start Guide - Public Cloud]
| link:{attachmentsdir}/pdfs/uyuni_quickstart-public-cloud_guide.pdf[QPC, window="_blank" role="green"]

| xref:large-deployments:large-deployments-overview.adoc[Large Deployments Guide]
| link:{attachmentsdir}/pdfs/uyuni_large-deployments_guide.pdf[LD, window="_blank" role="green"]
